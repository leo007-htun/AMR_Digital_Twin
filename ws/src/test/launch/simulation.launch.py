...
ros2_pkg_path = get_package_share_directory("test")
simulation_world_file_path = Path(ros2_pkg_path, "world/warehouse.sdf").as_posix()
...
def generate_launch_description():
    return LaunchDescription([
        ...
        Node(
            ...
            arguments=["/model/2023_AMR/cmd_vel@geometry_msgs/msg/Twist@ignition.msgs.Twist"], 
            # ros_arguments=["-r /model/wheeled_model/cmd_vel:=/cmd_vel"], # Remapping topic in terminal 
            remappings=[("/model/2023_AMR/cmd_vel", "/cmd_vel")], # Remapping topic in launch file
            output="screen"
        ),
